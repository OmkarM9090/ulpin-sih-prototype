    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', position: 'relative' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto' }}>
        ...
        <div style={{ padding: '0 16px 24px' }}>
          <div style={{ fontSize: '13px', fontWeight: 600, color: 'var(--text-primary)', marginBottom: '8px' }}>Creation Info</div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', fontSize: '11px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'var(--text-muted)' }}>Generated By:</span>
              <span style={{ color: 'var(--text-primary)' }}>GeoCadastre 3D Engine v1.0.0</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span style={{ color: 'var(--text-muted)' }}>Pipeline Stage:</span>
              <span style={{ color: 'var(--success)' }}>7/7 Complete</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              <span style={{ color: 'var(--warning)' }}>Controlled Demo Data</span>
            </div>
          </div>
        </div>
      </div>
